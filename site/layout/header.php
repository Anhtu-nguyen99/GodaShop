        ...
        <header>
            ...
            <div class="top-navbar container-fluid">
                <div class="menu-mb">
                    ...
                    <a class="<?=($c == "information" && $a == "returnPolicy") ? "active": ""?>" href="index.php?c=information&a=returnPolicy">Chính sách đổi trả</a>
                    <a class="<?=($c == "information" && $a == "paymentPolicy") ? "active": ""?>" href="index.php?c=information&a=paymentPolicy">Chính sách thanh toán</a>
                    <a class="<?=($c == "information" && $a == "deliveryPolicy") ? "active": ""?>" href="index.php?c=information&a=deliveryPolicy">Chính sách giao hàng</a>
        ...
        <nav class="navbar navbar-default desktop-menu">
            <div class="container">
                <ul class="nav navbar-nav navbar-left hidden-sm hidden-xs">
                    ...
                    <li class="<?=$c == "product" ? "active": ""?>"><a href="index.php?c=product&a=list">Sản phẩm </a></li> 
                    <li class="<?=($c == "information" && $a == "returnPolicy") ? "active": ""?>"><a href="index.php?c=information&a=returnPolicy">Chính sách đổi trả</a></li>
                    <li class="<?=($c == "information" && $a == "paymentPolicy") ? "active": ""?>"><a href="index.php?c=information&a=paymentPolicy">Chính sách thanh toán</a></li>
                    <li class="<?=($c == "information" && $a == "deliveryPolicy") ? "active": ""?>"><a href="index.php?c=information&a=deliveryPolicy">Chính sách giao hàng</a></li>
